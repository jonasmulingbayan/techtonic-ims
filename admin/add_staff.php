								...
								<div class="row">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="email" type="email" class="form-control" required="true" onkeypress="if(event.keyCode==32)event.returnValue=false;" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="password" type="password" placeholder="**********" class="form-control" required="true" onkeypress="if(event.keyCode==32)event.returnValue=false;" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
									...
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input name="phonenumber" type="text" class="form-control" required="true" pattern="[0-9]{11}" maxlength="11" onkeypress="if(event.keyCode<48 || event.keyCode>57)event.returnValue=false;" autocomplete="off">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
											...
											<input id = "dob" name="dob" type="text" class="form-control date-picker" required="true" autocomplete="off">
										</div>
									</div>
									<div class="col-md-4 col-sm-12">
										<div class="form-group">
